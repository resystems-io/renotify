...
- [System Block Diagram (Embedded Broker)](#system-block-diagram-embedded-broker)
- [Shared Broker Deployment](#shared-broker-deployment)
- [Notification Flow (post)](#notification-flow-post)
- [Interactive Ask Flow](#interactive-ask-flow)
- [Hook Dispatch Flow (PermissionRequest)](#hook-dispatch-flow-permissionrequest)
- [Interjection Flow](#interjection-flow)
- [Port Architecture](#port-architecture)
- [NATS Subject Namespace](#nats-subject-namespace)
  - [Flow-scoped subjects (JetStream)](#flow-scoped-subjects-jetstream)
  - [State service subjects (Core NATS Request-Reply)](#state-service-subjects-core-nats-request-reply)
  - [Ephemeral subjects (Core NATS)](#ephemeral-subjects-core-nats)
