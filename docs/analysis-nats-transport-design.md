...
- [1. Subject Catalogue](#1-subject-catalogue)
  - [1.1 Subject Registry](#11-subject-registry)
  - [1.2 Subscription Patterns](#12-subscription-patterns)
- [2. JetStream Configuration](#2-jetstream-configuration)
  - [2.1 Stream Definition](#21-stream-definition)
  - [2.2 Consumer Definitions](#22-consumer-definitions)
- [3. Delivery Guarantees](#3-delivery-guarantees)
  - [3.1 Per-Transport Guarantees](#31-per-transport-guarantees)
  - [3.2 Idempotency Analysis](#32-idempotency-analysis)
  - [3.3 Timeout Semantics](#33-timeout-semantics)
- [4. Listener Configuration](#4-listener-configuration)
  - [4.1 Embedded Broker Listeners](#41-embedded-broker-listeners)
  - [4.2 Shared Broker Model](#42-shared-broker-model)
  - [4.3 `ProvisioningPayload` Port](#43-provisioningpayload-port)
- [5. TLS Certificate Management](#5-tls-certificate-management)
  - [5.1 Certificate Parameters](#51-certificate-parameters)
  - [5.2 Storage](#52-storage)
  - [5.3 Fingerprint Computation](#53-fingerprint-computation)
  - [5.4 Certificate Lifecycle](#54-certificate-lifecycle)
  - [5.5 Android TLS Trust Bootstrap](#55-android-tls-trust-bootstrap)
- [6. Auth Token Design](#6-auth-token-design)
  - [6.1 Token Format](#61-token-format)
  - [6.2 Generation](#62-generation)
  - [6.3 Storage](#63-storage)
  - [6.4 NATS Auth Integration (Embedded Broker)](#64-nats-auth-integration-embedded-broker)
  - [6.5 NATS Auth Integration (Shared Broker)](#65-nats-auth-integration-shared-broker)
  - [6.6 Device Credential Lifecycle](#66-device-credential-lifecycle)
  - [6.7 Why Token Authentication Over NKeys](#67-why-token-authentication-over-nkeys)
- [7. NATS Authorisation and ACL Design](#7-nats-authorisation-and-acl-design)
  - [7.1 Actor Roles](#71-actor-roles)
  - [7.2 Daemon (Internal) Permissions](#72-daemon-internal-permissions)
  - [7.3 Mobile Client Permissions](#73-mobile-client-permissions)
  - [7.4 Post-MVP ACL Enhancements](#74-post-mvp-acl-enhancements)
- [8. Connection Lifecycles](#8-connection-lifecycles)
  - [8.1 Daemon Startup (Embedded Broker)](#81-daemon-startup-embedded-broker)
  - [8.2 Daemon Startup (Shared Broker)](#82-daemon-startup-shared-broker)
  - [8.3 Pairing (`renotify pair`)](#83-pairing-renotify-pair)
  - [8.4 Mobile First Connection](#84-mobile-first-connection)
  - [8.5 Mobile Reconnection After Network Drop](#85-mobile-reconnection-after-network-drop)
  - [8.6 CLI Command Connection (`renotify ask`)](#86-cli-command-connection-renotify-ask)
  - [8.7 Device Revocation (`renotify revoke`)](#87-device-revocation-renotify-revoke)
  - [8.8 Interjection Delivery](#88-interjection-delivery)
- [9. Deployment Model Comparison](#9-deployment-model-comparison)
