...
- [1. Full Topology](#1-full-topology)
- [2. System Elements and Identifiers](#2-system-elements-and-identifiers)
  - [2.1 NATS Broker](#21-nats-broker)
  - [2.2 User](#22-user)
  - [2.3 Daemon Instance](#23-daemon-instance)
  - [2.4 Workspace](#24-workspace)
  - [2.5 Flow (renamed from "Session")](#25-flow-renamed-from-session)
- [3. Identifier Summary Table](#3-identifier-summary-table)
- [4. NATS Namespace Redesign](#4-nats-namespace-redesign)
  - [4.1 Current Design (problematic)](#41-current-design-problematic)
  - [4.2 Proposed Design](#42-proposed-design)
  - [4.3 Subscription Patterns](#43-subscription-patterns)
  - [4.4 Benefits Over Current Design](#44-benefits-over-current-design)
- [5. New Payload: DaemonHeartbeat](#5-new-payload-daemonheartbeat)
- [6. Impact on Existing Payloads](#6-impact-on-existing-payloads)
  - [6.1 FlowLifecycleEvent (was SessionLifecycleEvent)](#61-flowlifecycleevent-was-sessionlifecycleevent)
  - [6.2 NotificationRequest](#62-notificationrequest)
  - [6.3 InterjectionCommand](#63-interjectioncommand)
  - [6.4 ActiveFlowsQuery / ActiveFlowsResult (was ActiveSessionsQuery/Result)](#64-activeflowsquery-activeflowsresult-was-activesessionsqueryresult)
  - [6.5 Shared Types](#65-shared-types)
  - [6.6 Other Payloads (unchanged structurally)](#66-other-payloads-unchanged-structurally)
- [7. Impact on Pairing and Provisioning](#7-impact-on-pairing-and-provisioning)
  - [7.1 Two Broker Deployment Models](#71-two-broker-deployment-models)
  - [7.2 Pairing Scenarios](#72-pairing-scenarios)
- [8. Terminology Rename Summary](#8-terminology-rename-summary)
